...
app:
  datasources:
    dakar:
      url: jdbc:postgresql://<URL_DAKAR>
      username: dsms_user
      password: <mot_de_passe>
    thies:
      url: jdbc:postgresql://<URL_THIES>
      username: dsms_user
      password: <mot_de_passe>
    stl:
      url: jdbc:postgresql://<URL_STLOUIS>
      username: dsms_user
      password: <mot_de_passe>
...
👩‍💻 Émilie Napele Gomes et Samsidine Coly
...
Les montants sont enregistrés en FCFA
